...
/// <summary>
/// Gets the hard-coded biome information from vanilla Minecraft.
/// </summary>
public static class BiomeData
{
    ...
    /// </summary>
    private static readonly Vector3 DefaultWaterSurfaceColor = new() {X = 37f / 255f, Y = 150f / 255f, Z = 190f / 255f};
    
    /// <summary>
    /// Gets the default void biome.
    /// </summary>
    private static Biome Void { get; } = new()
    {
    ...
    private static void Add(string name, float temperature, float rainfall, Vector3 waterSurfaceColor)
    {
    ...
    /// <param name="temperature"></param>
    /// <param name="rainfall"></param>
    private static void Add(string name, float temperature, float rainfall)
    {
        Biomes.Add(name, new Biome()
        {
            Name = name,
